                        ...
                        <div class="row">
                            <div class="col-lg-12 ">
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                            <form method="post" action="{{ route('admin.socialIcon.store') }}">
                                                @csrf
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Font Awesome Class(V5) <span class="text-danger">*</span> </label>
                                                    <input type="text" name="icon" class="form-control" value="{{old('icon')}}" placeholder="Enter icon"/>
                                                    @error('icon')
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="link" class="form-control" placeholder="Enter Icon Link"/>
                                                    @error('link')
                                                        <span class="text text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
