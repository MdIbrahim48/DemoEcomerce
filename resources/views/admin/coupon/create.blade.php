            ...
            <div class="col-8 m-auto">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h4 class="card-title text-center" style="color: #ffffff">Add Coupon</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 ">
                                        ...
                                        <div>
                                            <form method="post" action="{{ route('admin.coupon.store') }}">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="min_spend" class="form-control" value="{{old('min_spend')}}"/>
                                                    @error('min_spend')
                                                        <span class="text text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="usage_limit_per_coupon" class="form-control" value="{{old('usage_limit_per_coupon')}}"/>
