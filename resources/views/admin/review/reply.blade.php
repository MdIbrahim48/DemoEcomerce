                ...
                <div class="card">
                    ...
                    <div class="card-body m-auto">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($allReplies as $replyItem)
                                    <span>{{$replyItem->message}}</span> <br>
                                @endforeach
                            <form action="{{ route('admin.review.reply.submit') }}" method="POST">
                                @csrf
                                <input class="form-control" type="hidden" name="review_id" value="{{ $review->id }}"><br>
