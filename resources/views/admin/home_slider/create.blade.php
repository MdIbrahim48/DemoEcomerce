            ...
            <div class="col-8 m-auto">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h4 class="card-title text-center" style="color: #ffffff">Add Home Slider</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 ">
                                        ...
                                        <div>
                                            <form method="post" action="{{ route('admin.homeSlider.store') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="links" class="form-control" value="{{old('links')}}" placeholder="Enter Links" />
                                                    @error('links')
                                                        <span class="text text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
