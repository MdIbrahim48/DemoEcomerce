            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We found <strong class="text-brand">{{ $subcategories->product->count() }}</strong> items for you!</p>
                    </div>
    ...
    @section('frontend_scripts')
        ...
        <script>
            function productFilterPrice(x,y){
                ...
                $.ajax({
                    type:'GET',
                    url:'{!!URL::to('subcategoryFilterPrice')!!}',
                    data:{'perPage':x,'slug':y},
                    success:function(response){
                        $('#categoryWiseProducts').html(response.view);
                        $('.sort-by-cover').removeClass('show');
