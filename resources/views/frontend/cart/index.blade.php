        ...
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <div class="d-flex justify-content-between">
                    <h6 class="text-body">There are <span class="text-brand">66</span> products in your cart</h6>
                    <h6 class="text-body"><a href="#" onclick="cartClear()" class="text-muted"><i class="fi-rs-trash mr-5"></i>Clear Cart</a></h6>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8">
                <div class="table-responsive shopping-summery">
                    <table class="table table-wishlist">
                        ...
                        <tbody id="cart_products1">

                                @include('frontend.includes.cartProducts')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart_total_amount">
                                        ...
                                        @endphp
                                        <h4 id="total" class="text-brand text-end">${{ $subTotal }}</h4>
                                        @endif
...
@endif
    ...
    <script>
        function quantityIncrement(x){
            $.ajax({
                type:'GET',
                url:'{!!URL::to('cart/increment')!!}',
                data:{'productId':x},
                success:function(response){
                    $('#subtotal'+x ).html('$'+response.subtotal_price);
                    $('#qtyVal'+x ).html(response.quantity);
       ...
       function quantityDecrement(y){
            $.ajax({
                type:'GET',
                url:'{!!URL::to('cart/decrement')!!}',
                data:{'productId':y},
                success:function(response){
                    $('#subtotal'+y).html('$'+ response.subtotal_price);
                    $('#qtyVal'+y ).html(response.quantity);
                    $('#subtotal').html(response.subTotal);
                    $('#total').html(response.subTotal);
                },
            });
       ...
       function productRemove(y){
            $.ajax({
                ...
                success:function(response){
                    ...
                    $('#total').html(response.sub_total);
                    $('#cart_products1').html(response.view);
                },
            });
        }
